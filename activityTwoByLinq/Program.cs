...
namespace activityTwoByLinq
{
    ...
    class activityTwoByLinq
    {
        ...
        public void groupByColorMethod(activityTwoByLinq activityTwoByLinq)
        {
            ...
            var colorGroup = from fruit in activityTwoByLinq.fruits
                                 group fruit by fruit.Color into fruitGroupWithColor
                                 select fruitGroupWithColor;
            foreach (var name in colorGroup)
            {
                Console.WriteLine(("Color  = " + name.Key));
                foreach (var fr in name)
                {
        ...
        public IEnumerable<Fruit> redFruitsMethod(activityTwoByLinq activityTwoByLinq)
        {
            ...
            var expensiveFruit = from fruit in activityTwoByLinq.fruits
        ...
        {
            double myBudget = 20;
            var getRedAndGreenFruit = from fruit in activityTwoByLinq.fruits
        ...
        {
            var fruitsInDescendingOrder = from fruit in activityTwoByLinq.fruits
